...
function pageMain(){
	...
	$User_FLname = $FirstName = $LastName = $Tel = $Email = $Password = $State = $City = '';
	...
	if(! Authorization::check('UserAdd')){

		Alert::alerts("شما مجوز اضافه کردن کاربر را ندارید");
	...
	include("../Includes/Views/AddNewUser_Form.php");
}
	
include "../Includes/Views/templates/UserPanel/master_UserPanel.php";

$pageTitle = "پنل کاربری >> ثبت کاربر";	
