...
include('../ReLoShop/Includes/Header.php');
...
if($CheckInput == 7){
	...
	$sql = "INSERT INTO Users(FirstName, LastName, Tel, Email, Password, Role, Logged)
		VALUES('{$FirstName}', '{$LastName}', '{$Tel}', '{$Email}', '{$Password}', '0', 0)";

	$db = new DB();
	$db -> Execute($sql);
	unset($db);
	redirect("A_Register.php");
}
...
include('../ReLoShop/Includes/Footer.php');
?>
